...
define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/api/messages",
    "title": "Request all messages of user (restriction: authenticated)",
    "name": "GetAllMessagesReceived",
    "group": "Message",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "server/api/message/chatroom.controller.js",
    "groupTitle": "Message"
  },
  {
    "type": "get",
    "url": "/api/messages/:with",
    "title": "Request messages with a specific user",
        ...
        "route params": [
          {
            ...
            "optional": false,
            "field": "with",
            "description": "<p>Unique ID of opponent.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "post",
    "url": "/api/messages",
    "title": "Send a message (restriction: authenticated)",
    "name": "SendMessage",
    "group": "Message",
    "parameter": {
      "fields": {
        "request body": [
          {
            ...
            "optional": false,
            "field": "to",
            "description": "<p>id of receiver</p>"
          },
          {
            "group": "request body",
            "type": "String",
      ...
      "fields": {
        ...
        "request body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "myAgent",
            "description": "<p>(OPTIONAL) id of User's selected Agent</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "myAgent",
            "description": "<p>agent object ex) {_id: '59483862c27e982e0f84c210', name: 'Hyungwu Pae', photoURL: &quot;https://sokaspdo.asodkasd.asdasd/soks.jpg&quot;}</p>"
          }
        ]
      },
      "examples": [
...
define({ "api": [
  ...
  },
  {
        ...
        "route params": [
          {
            ...
            "optional": false,
            "field": "roomId",
            "description": "<p>Unique ID of chat room.</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "server/api/message/message.controller.js",
    "groupTitle": "Message"
  },
  {
    "type": "post",
